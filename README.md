...
* Activate Or Deactivate Profile Individually, so you don't need to adjust remap every single time.
* Run Profile On Startup, so you can activate profile every time you open the computer without needed to activate manually.
...
3. Store Profile :
* If you don't want to show profile in the main window but you still need it or you just want to store it for future, you can store the profile using "Store" button. If you happen want to run it, you can use "Show Stored Profile" and it will show your stored profile or you want to show it back in main window, you can use "Retrieve" button to move it to main window.
4. Run On Startup :
